...
class UserCreateSerializer(serializers.Serializer):
    ...
    tickets_peru = serializers.IntegerField(default=0)
    tickets_silver = serializers.IntegerField(default=0)
    tickets_gold = serializers.IntegerField(default=0)
    tickets_plum = serializers.IntegerField(default=0)
...
class UserGetSerializer(serializers.Serializer):
    ...
    tickets_peru = serializers.IntegerField()
    tickets_silver = serializers.IntegerField()
    tickets_gold = serializers.IntegerField()
    tickets_plum = serializers.IntegerField()
...
class UserUpdateSerializer(serializers.Serializer):
    ...
    tickets_peru = serializers.IntegerField(required=False)
    tickets_silver = serializers.IntegerField(required=False)
    tickets_gold = serializers.IntegerField(required=False)
    tickets_plum = serializers.IntegerField(required=False)
...
class HabitGetSerializer(serializers.Serializer):
    ...
    tuseday = serializers.BooleanField(read_only=True)
...
class HabitCreateSerializer(serializers.Serializer):
    ...
    tuseday = serializers.BooleanField(default=False)
